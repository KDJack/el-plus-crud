  ...
  setup(d, { expose: s, emit: r }) {
    ...
    const A = Ae(() => o.size || y.size), S = [...ya, ...((Gt = y.form) == null ? void 0 : Gt.comList) || []], w = Ae(() => ({ display: "flex", flexDirection: o.isTable ? "row" : "column" })), B = Ae(() => ({
      ...
      if (I.type === "category")
        ...
        J && J.length === 2 && (ae.startTime = J[0], typeof J[1] == "string" ? ae.endTime = new Date(J[1]).getTime() : ae.endTime = J[1], ae.endTime = ae.endTime + (24 * 60 * 60 - 1) * 1e3, ae.startTime = N.time(ae.startTime, 3), ae.endTime = N.time(ae.endTime, 3));
                    ...
                    default: U(() => {
                      ...
                      return [
                        q._vif ? (_(), Q("div", {
                          ...
                          ie(J, {
                            style: yt([{ "min-height": "40px", display: "flex" }, { width: ((it = q._attrs) == null ? void 0 : it.width) || q.width || (I.isTable ? "150px" : "100%") }]),
